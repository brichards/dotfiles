...
echo "Setting macOS System and Application Preferences..."
...
# Disable GateKeeper to prevent the quarantine dialoge from reappearing
...
###############################################################################
echo "Setting Trackpad, mouse, keyboard, Bluetooth accessories, and input preferences..."
...
# defaults write MobileMeAccounts Accounts Services -dict-add "
#   <dict>
#     <key>Enabled</key><false/>
#     <key>MSNeedsPassword</key><integer>1</integer>
#     <key>Name</key><string>PHOTO_STREAM</string>
#     <key>ServiceID</key><string>com.apple.Dataclass.Photos</string>
#   </dict>
# "

# Disable Keyboard > Shortcuts > Spotlight > Show Spotlight search
...
# Set default view for all new Finder windows
# View modes: Icons: `icnv`, List: `Nlsv`, Columns: `clmv`, Gallery: `glyv`
...
###############################################################################
echo "Setting Dock, Dashboard, and Hot Corners preferences."
...
# Top right screen corner → 4. Desktop
#defaults write com.apple.dock wvous-tr-corner -int 4
#defaults write com.apple.dock wvous-tr-modifier -int 0

# Bottom left screen corner → 5. Start screen saver
#defaults write com.apple.dock wvous-bl-corner -int 5
#defaults write com.apple.dock wvous-bl-modifier -int 0

# Bottom right screen corner → 0. Disabled
...
# Safari & WebKit                                                             #
###############################################################################
echo "Setting Safari & WebKit preferences (j/k, these don't work)."

# # Privacy: don’t send search queries to Apple
# defaults write com.apple.Safari UniversalSearchEnabled -bool false
# defaults write com.apple.Safari SuppressSearchSuggestions -bool true

# # Autofill: don't offer to save usernames and passwords
...
# Terminal & iTerm 2                                                          #
###############################################################################
echo "Setting Terminal & iTerm preferences."
...
# Load iTerm prefs from Dropbox
defaults write com.googlecode.iterm2 LoadPrefsFromCustomFolder -bool true
defaults write com.googlecode.iterm2 PrefsCustomFolder -string "$HOME/Dropbox/App Settings"
defaults write com.googlecode.iterm2 "NoSyncNeverRemindPrefsChangesLostForFile_selection" -string "2"

# Stop iTerm from prompting on quit
...
###############################################################################
echo "Setting Address Book, Dashboard, iCal, TextEdit, and Disk Utility  preferences."
...
###############################################################################
echo "Setting Chrome and Canary preferences."
...
read -p "Restart now ([y]/n)? " force_restart
force_restart=${force_restart:-y}

if [ "$force_restart" != "${force_restart#[Yy]}" ]; then
    sudo shutdown -r now
fi
